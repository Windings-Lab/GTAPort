...
{
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(InputTag_Native_Vehicle_Move, "InputTag.Native.Vehicle.Move", "Vehicle XYZ Movement");
	...
	UE_DEFINE_GAMEPLAY_TAG_COMMENT(Ability_Behavior_VehicleControl, "Ability.Behavior.VehicleControl", "Vehicle Control/Exit");
}